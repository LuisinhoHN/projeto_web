...
<head>
    ...
    <title>Minhas Finanças - Adicionar Meta</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Adicionar Meta</h1>
                        <!-- Breadcrumb -->
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="..\AdicionarMetaServlet" method="post">
                            <div class="form-group">
                                <label>Nome</label>
                                <input placeholder="HB 20 Comfort" class="form-control" name="nomeMeta">
                                <p class="help-block">Qual sua meta? Casa, carro, viagem?</p>
                            </div>
                            <div class="form-group">
                                <label>Valor total</label>
                                <input placeholder="40.000,00" class="form-control" name="valorTotalMeta">
                                <p class="help-block">Valor total do bem</p>
                            </div>
                            <div class="form-group">
                                <label>Percentual da poupança</label>
                                <input placeholder="20%" class="form-control" name="porcentualPoupancaMeta">
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="12" class="form-control" name="parcelasPrevistaMeta">
