...
<%        
    List<FormaPagamento> listaFormasPagamento = null;
    
    DaoFactory daoFactory = DaoFactory.getInstance();

    Usuario oCara = (Usuario) sessao.getAttribute("oCara");

    listaFormasPagamento = daoFactory.criarFormaPagamentoDao().findFormasPagamento(oCara);
...
<html lang="en">
    ...
    <head>
        ...
        <title>Minhas Finanças - Visualizar Formas de Pagamento</title>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                    <button type="button"
                                            onclick="window.location.href = 'adicionar_forma_pagamento.jsp'"
                                            class="btn btn-default btn-sm">
                                        <font color="blue"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></font></span> Cadastrar Forma de Pagamento
                                    </button>
                                    <br />
                                    <br />
                                    <tr>
                                    ...
                                    <tbody>
                                        <c:forEach items="${listaFormasPagamento}" var="formaPagamento">
                                            <tr class="odd gradeX">
                                                <td> <c:out value="${formaPagamento.nome}"/></td>
                                                <td> <c:out value="${formaPagamento.descricao}"/></td>
                                                <td align="center"><font color="blue">
                                                    <form method="POST" action="../SalvaFormaPagamentoServlet">
                                                        <input type="hidden" value="${formaPagamento.idFormaPagamento}" name="idFormaPagamento">
                                                    ...
                                                    <form method="POST" action="../ExcluirFormaPagamento">
                                                        <input type="hidden" value="${formaPagamento.idFormaPagamento}" name="idFormaPagamento">
                                                        <button type="submit" class="btn btn-default btn-sm">
                                                            <a href="#"><font color="blue"> 
