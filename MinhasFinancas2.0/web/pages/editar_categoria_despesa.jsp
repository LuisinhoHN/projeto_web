...
<%
    ...
    categoriaDespesa = daoFactory.criarCategoriaDespesaDao().find(idCategoriaDespesa);
%>
...
<html lang="pt">
    ...
    <head>
        ...
        <title>Minhas Finanças - Adicionar Categoria de Despesa</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <!-- Breadcrumb -->
                            <ol class="breadcrumb">
                                <li><a href="#">Categoria de Despesa</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" action="..\AtualizarCategoriaDespesa" method="POST">
                                <div class="form-group">
                                    <label>Nome</label>
                                    <input type="text" value="<%= categoriaDespesa.getNome() %>" id="nomeCategoriaDespesa" name="nomeCategoriaDespesa" class="form-control">
                                    <p class="help-block">Um nome para identificar sua categoria</p>
                                </div>

                                <div class="form-group">
                                    <label>Descrição</label>
                                    <input type="text" value="<%= categoriaDespesa.getDescricao() %>" id="descricaoCategoriaDespesa" name="descricaoCategoriaDespesa" class="form-control">
                                    <p class="help-block">Estudos, livros, eventos, palestras</p>
                                </div>
