...
<%@page import="MinhasFinancas.model.Meta"%>
...
<%
    ...
    meta = daoFactory.criarMetaDao().find(idMeta);
%>
<!DOCTYPE html>
<html lang="pt">
...
<head>
    ...
    <title>Minhas Finanças - Editar Meta</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="..\AtualizarMeta" method="post">
                            <div class="form-group">
                                <label>Nome</label>
                                <input value=" <%= meta.getNome() %> " class="form-control" name="nomeMeta">
                                <p class="help-block">Qual sua meta? Casa, carro, viagem?</p>
                            </div>
                            <div class="form-group">
                                <label>Valor total</label>
                                <input value=" <%= meta.getValorTotal() %> " class="form-control" name="valorTotalMeta">
                                <p class="help-block">Valor total do bem</p>
                            </div>
                            <div class="form-group">
                                <label>Percentual da poupança</label>
                                <input value=" <%= meta.getPercentualPoupanca() %> " class="form-control" name="porcentualPoupancaMeta">
                                <p class="help-block">O quanto a meta vai retirar do que sobra após os gastos</p>
                            </div>
 
                            <!--<div class="form-group">
                                <label>Moeda</label>
                                <select class="form-control" name="moedaMeta">
                            ...
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="tipoMeta" id="optionsRadiosInline1" value="Estática" checked>Estática
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="tipoMeta" id="optionsRadiosInline2" value="Dinâmica">Dinâmica
                                </label>
                            </div>
                            
                            <div class="form-group">
                                <label>Parcelas previstas</label>
                                <input value=" <%= meta.getParcelasPrevistasTotal() %> " class="form-control" name="parcelasPrevistaMeta">
                                <p class="help-block">A quantidade de parcelas que serão necessárias para atingir a meta, 
                                caso a meta seja estática</p>
                            </div>
