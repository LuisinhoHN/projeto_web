    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="..\AdicionarFormaPagamentoServlet" method="POST">
                                        <div class="form-group">
                                            <label>Nome</label>
                                            <input placeholder="Cartão de débito BB" class="form-control" name="nomeFormaPagamento">
                                            <p class="help-block">Um nome para sua forma de pagamento</p>
                                        </div>
                                                                                
                                        <div class="form-group">
                                            <label>Descrição</label>
                                            <input placeholder="Gastos usando o cartão de débito BB, que desconta da conta corrente X"class="form-control" name="descricaoFormaPagamento">
