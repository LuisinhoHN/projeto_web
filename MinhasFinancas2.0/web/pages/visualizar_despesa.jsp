...
<%          
   ...
   listaDespesas = daoFactory.criarDespesasDao().findDespesas(oCara);
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                    <button type="button"
                                            onclick="window.location.href = 'adicionar_despesa.jsp'"
                                    ...
                                    <tbody>
                                        <c:forEach items="${listaDespesas}" var="despesa">
                                            <tr class="odd gradeX">
                                                ...
                                                <td> <c:out value="${despesa.moedaId.nome}"/></td>
                                                <td> <c:out value="${despesa.categoriaDespesaId.nome}"/></td>
                                                <td> <c:out value="${despesa.formaPagamentoId.nome}"/></td>
                                                <td> <c:out value="${despesa.tipoDespesaId.nome}"/></td>
                                                <td> <c:out value="${despesa.intervalo}"/></td>
                                                <td align="center"><font color="blue">
                                                    <form action="../SalvaDespesaServlet" method="POST">
                                                    ...
                                                    <form action="../ExcluirDespesaServlet" method="POST">
                                                        <input type="hidden" value="${despesa.idDespesa}" name="idDespesa">
                                                        <button type="submit" class="btn btn-default btn-sm">
                                                            <a href="#"><font color="blue"> 
