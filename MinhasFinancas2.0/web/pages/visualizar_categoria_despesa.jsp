...
<%@page import="MinhasFinancas.model.CategoriaDespesa" %>
<%@page import="java.util.List" %>

<%@include file="../includes/sessaoPaginaInterna.jsp" %> 
<%       

    List<CategoriaDespesa> listaCategoriasDespesa = null;

    DaoFactory daoFactory = DaoFactory.getInstance();

    Usuario oCara = (Usuario) sessao.getAttribute("oCara");

    listaCategoriasDespesa = daoFactory.criarCategoriaDespesaDao().findCategoriasDespesa(oCara);

    request.setAttribute("listaCategoriasDespesa", listaCategoriasDespesa);
...
<html lang="en">
    ...
    <head>
        ...
        <title>Minhas Finanças - Visualizar Categorias de Despesa</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                            ...
                            Visualizar Categoria de Despesa
                        </h1>
                        <ol class="breadcrumb">
                            <li><a href="#">Categorias de Despesa</a></li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                    <button type="button"
                                            onclick="window.location.href = 'adicionar_categoria_despesa.jsp'"
                                            class="btn btn-default btn-sm">
                                        <font color="blue"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></font></span> Cadastrar Categoria de Despesa
                                    </button>
                                    <br />
                                    <br />
                                    <tr>
                                    ...
                                    <tbody>
                                        <c:forEach items="${listaCategoriasDespesa}" var="categoriaDespesa">
                                            <tr class="odd gradeX">
                                                <td> <c:out value="${categoriaDespesa.nome}"/></td>
                                                <td> <c:out value="${categoriaDespesa.descricao}"/></td>
                                                <td align="center"><font color="blue">
                                                    <form action="../SalvaCategoriaDespesaServlet" method="POST">
                                                        <input type="hidden" value="${categoriaDespesa.idCategoriaDespesa}" name="idCategoriaDespesa">
                                                    ...
                                                    <form action="../ExcluirCategoriaDespesa" method="POST">
                                                        <input type="hidden" value="${categoriaDespesa.idCategoriaDespesa}" name="idCategoriaDespesa">
                                                        <button type="submit" class="btn btn-default btn-sm">
                                                            <a href="#"><font color="blue"> 
