...
<%    List<Meta> listaMetas = null;

    DaoFactory daoFactory = DaoFactory.getInstance();

    Usuario oCara = (Usuario) sessao.getAttribute("oCara");
    // Falta ajeitar aqui
    listaMetas = daoFactory.criarMetaDao().findMetas(oCara);
...
<html lang="en">
    ...
    <head>
        ...
        <title>Minhas Finanças - Acompanhar Metas</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Acompanhar Metas</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                    <button type="button"
                                            onclick="window.location.href = 'adicionar_meta.jsp'"
                                            class="btn btn-default btn-sm">
                                        <font color="blue"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></font></span> Cadastrar Meta
                                    </button>
                                    <br />
                                    <br />
                                    <tr>
                                        <th>Nome</th>
                                        <th>Valor Total</th>
                                        <th>Porcentual da poupança</th>
                                        <th>Tipo</th>
                                        <th>Parcelas previstas</th>
                                        <th>Ação</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${listaMetas}" var="meta">
                                            <tr class="odd gradeX">
                                                <td> <c:out value="${meta.nome}"/></td>
                                                <td> <c:out value="${meta.valorTotal}"/></td>
                                                <td> <c:out value="${meta.percentualPoupanca}"/></td>
                                                <td> <c:out value="${meta.tipo}"/></td>
                                                <td> <c:out value="${meta.parcelasPrevistasTotal}"/></td>
                                                <td align="center"><font color="blue">
                                                    <form action="../SalvaMetaServlet" method="POST">
                                                        <input type="hidden" value="${meta.idMeta}" name="idMeta">
                                                    ...
                                                    <form action="../ExcluirMeta" method="POST">
                                                        <input type="hidden" value="${meta.idMeta}" name="idMeta">
                                                        <button type="submit" class="btn btn-default btn-sm">
                                                            <a href="#"><font color="blue"> 
