        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" action="..\AdicionarCategoriaDespesa" method="POST">
                                <div class="form-group">
                                    <label>Nome</label>
                                    <input placeholder="Educação" type="text" id="nomeCategoriaDespesa" name="nomeCategoriaDespesa" class="form-control">
                                    <p class="help-block">Um nome para identificar sua categoria</p>
                                </div>

                                <div class="form-group">
                                    <label>Descrição</label>
                                    <input type="text" id="descricaoCategoriaDespesa" name="descricaoCategoriaDespesa" class="form-control">
