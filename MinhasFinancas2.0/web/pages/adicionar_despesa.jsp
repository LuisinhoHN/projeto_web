...
<html lang="pt">
    ...
    <head>
        ...
        <title>Minhas Finanças - Adicionar Despesa</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="POST" action="../AdicionarDespesaServlet">
                                <div class="form-group">
                                    <label>Data</label>
                                    <!-- Pegar a data do dia atual automaticamente. O campo só existe caso o usuário faça uma receita retroativa-->
                                    <input type="date" id="dataCompra" name="dataCompra" value="2016-10-06" class="form-control">
                                    <p class="help-block">Qual a data que ocorreu essa despesa?</p>
                                </div>
                                <div class="form-group">
                                    <label>Descrição</label>
                                    <input type="text"  id="descricaoDespesa" name="descricaoDespesa" placeholder="Lanche no carrinho de doces" class="form-control">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" placeholder="50,00" id="precoDespesa" name="precoDespesa" class="form-control"></input>
