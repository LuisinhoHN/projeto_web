...
<%
    ...
    Receita resultadoReceita = null;

    DaoFactory daoFactory = DaoFactory.getInstance();
    
    resultadoReceita = daoFactory.criarReceitasDao().find(idReceita);
%>
...
<head>
    ...
    <title>Minhas Finanças - Editar Receita</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row">
                                <div class="col-lg-6">
                                    <form method="POST" action="..\AtualizarReceitaServlet">
                                        <div class="form-group">
                                            <label>Data</label>
											<!-- Pegar a data do dia atual automaticamente. O campo só existe caso o usuário faça uma receita retroativa-->
                                            <input type="date" id="dataCompra" name="dataCompra" value="2016-10-06" class="form-control" value="<%= resultadoReceita.getDataReceita() %>">
                                            <p class="help-block">Qual a data que você obteve essa receita?</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Descrição</label>
                                            <input type="text" id="descricaoReceita" name="descricaoReceita" class="form-control" value="<%= resultadoReceita.getDescricao() %>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group input-group">
                                                ...
                                                <input type="number" placeholder="100,00" id="preco" name="preco" class="form-control" value="<%= resultadoReceita.getValor() %>"></input>
                                            </div>											
                                        </div>
                                        <div class="form-group">
                                            <label>Moeda</label>
