...
public class ExcluirFormaPagamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // FormaPagamentoFinder não é usada
        //FormaPagamentoDao = FormaPagamentoFinder = daoInstance.criarFormaPagamentoDao();
        //CategoriaDespesaDao categoriaDespesaFinder = daoInstance.criarCategoriaDespesaDao();
        
        FormaPagamentoDao formaPagamentoREMOVER = daoInstance.criarFormaPagamentoDao();
        //CategoriaDespesaDao categoriaDespesaREMOVER = daoInstance.criarCategoriaDespesaDao();
        
        
        FormaPagamento formaPagExcluir = new FormaPagamento();
        //CategoriaDespesa categoriaDespExcluir = new CategoriaDespesa();
        
        //Exclusao pelo id. (Exclusao direta)
        formaPagExcluir.setIdFormaPagamento(Integer.parseInt(request.getParameter("idFormaPagamento")));
        
        formaPagamentoREMOVER.destroy( formaPagExcluir.getIdFormaPagamento());
